...
if len(sys.argv) < 4:
    print("Usage: quickmath.py" <add|multi|div|sub|avg> <num01> <num02> [num03..99])
    exit(1)

w_addition = {"+", "add", "addition", "plus"}
w_subtraction = {"-", "minus", "sub", "subtract"}
...
if sys.argv[1] in w_addition:
    ...
    print("Usage: quickmath.py <add|mul|div|sub|avg> <num01> <numb02> [num03..num99]")
    exit(1)

print(str(result))
#example of running script
quickmath add 5 78 89